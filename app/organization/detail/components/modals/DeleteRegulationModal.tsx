...
interface DeleteRegulationModalProps {
  isOpen: boolean;
...
export default function DeleteRegulationModal({
  isOpen,
  regulationTitle,
  savingRegulation,
  onClose,
  onConfirm,
}: DeleteRegulationModalProps) {
