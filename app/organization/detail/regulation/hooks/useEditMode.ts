...
export function useEditMode({
  ...
  // 制度アイテムのタイトル編集開始（月タブと総括タブの両方に対応）
  ...
  }, [editingMonth, editingSection, editingContent, editingItemTitle, editingItemDate, editingItemTime, monthContents, setMonthContents, regulation, setHasUnsavedChanges, setSavingStatus, handleCancelEdit]);
